...
% Linear Quick (1974) function for psychometric curve estimation (Not yet implemented !!!)
%
...
%
% On donne ici sa transformation linéaire afin de pouvoir l'approximer
% avec une méthode d'interpolation à partir de points.
%
